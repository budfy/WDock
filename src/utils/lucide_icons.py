"""
Lucide Icons Integration for WDock
Provides access to Lucide.dev icon set for consistent UI design
"""
...
class LucideIcons:
    """Lucide Icons manager with embedded SVG content"""
    
    # Essential Lucide icons for WDock
    ICONS = {
        # System icons
        ...
        "help-circle": """<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><point x="12" y="17"/></svg>""",
        
        # Control icons
        "x": """<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>""",
        "menu": """<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>""",
        "plus": """<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>""",
    ...
    # Map WDock use cases to Lucide icons
    ICON_MAPPING = {
        "tray_icon": "layers",
        "show_dock": "eye",
        "hide_dock": "eye-off",
    ...
    @classmethod
    def render_icon(cls, icon_name: str, size: QSize = QSize(24, 24), 
                   color: QColor = QColor(128, 128, 128)) -> Optional[QPixmap]:
        """Render an icon to QPixmap with specified size and color"""
        ...
        # Create pixmap and paint the icon
        pixmap = QPixmap(size)
    ...
    @classmethod
    def create_qicon(cls, wdock_icon: str, size: int = 16, 
                    is_dark_theme: bool = False) -> Optional[QIcon]:
        """Create a QIcon from a WDock-specific icon mapping"""
        lucide_name = cls.ICON_MAPPING.get(wdock_icon)
        if not lucide_name:
            return None
        
        # Choose appropriate color for theme
        color = QColor(220, 220, 220) if is_dark_theme else QColor(64, 64, 64)
        
        pixmap = cls.render_icon(lucide_name, QSize(size, size), color)
        return QIcon(pixmap) if pixmap else None


# Global convenience functions
def get_lucide_icons():
    """Get the LucideIcons class for access to all functionality"""
    return LucideIcons

def get_wdock_icon(icon_name: str, size: int = 16, is_dark: bool = False) -> Optional[QIcon]:
    """Convenience function to get WDock icons"""
    return LucideIcons.create_qicon(icon_name, size, is_dark)
